...
public class ReadIni {
    ...
    public static void main(String[] args) {
        String filepath = "C:\\Users\\Administrator\\Desktop\\initest.ini";
        Map<String, Object> ini = readIni(filepath);
        for (String k : ini.keySet()) {
            System.out.println(k + ini.get(k));
        }

        System.out.println("获取单个值：" + ((Map<String, String>) ini.get("url1")).get("v1"));
    }
}
